    ...
    <div style={{ maxWidth: 420, margin: "0 auto", padding: "32px 20px",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
        {[
          ...
          <div key={key}>
            <label style={{
              fontSize: "11px", color: "var(--taupe)",
              display: "block", marginBottom: "6px", textAlign: "right",
            }}>
              {label}
            </label>
            <input
        ...
        <button
          ...
          style={{
            ...
            border: "none", background: saved ? "var(--taupe)" : "var(--charcoal)",
            color: "var(--ivory)", fontSize: "13px", fontFamily: "inherit",
